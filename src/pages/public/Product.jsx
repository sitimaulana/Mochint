...
const Product = () => {
  ...
  const categories = ['Best Seller', 'Acne', 'Brightening', 'Bundling'];
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {filteredProducts.length > 0 ? (
            filteredProducts.map((product) => (
              <div key={product.id} className="bg-white rounded-[35px] shadow-sm border border-gray-100 overflow-hidden group hover:shadow-[0_20px_50px_rgba(141,110,99,0.15)] transition-all duration-500">
                {/* Image Wrapper */}
                ...
                <div className="p-7">
                  ...
                  >
                    <div className="flex flex-col items-start">
                      ...
                      <span className="text-sm font-display font-bold">Rp {product.price}</span>
                    </div>
            ...
            <div className="col-span-full py-20 text-center">
              <p className="font-sans text-gray-400 italic">Produk tidak ditemukan...</p>
            </div>
          )}
        </div>
      </div>
